...
export default function About() {
  ...
  return (
    <>
    <div className="container py-3" style={myStyles}>
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" className="accordion-collapse collapse"  style={myStyles} aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div className="accordion-body">
    ...
    <div className="container"style={myStyles} >
        <button onClick={toggleStyle} className="my-3 btn btn-primary">{btnText}</button>
    </div>
    </>
  )
}
